...
@testset "BATS parity: Box-Cox, trend + damped, no ARMA" begin
    ...
    @test fit.damping_parameter ≈ 0.994476076897778 rtol=0.001
    @test fit.aic ≈ 1392.80758199023 rtol=0.001
    @test fit.aic <= 1402.161640106883851

    expected_fc = [442.920632097004, 438.581724617856, 497.146549143106,
                   483.294963061414, 486.308706113157, 554.340245286803,
                   622.010734663575, 624.797904219281, 542.541190533266,
                   474.833404183960, 414.949294234897, 467.193030866006]
    fc = forecast(fit; h=12)
