...
Finite-sample critical values are from Hamilton (1994, Tables B.5–B.7), originally
tabulated in Dickey & Fuller (1981).
...
- Hamilton, J. D. (1994). *Time Series Analysis.* Princeton University Press. Tables B.5–B.7.
